...
from src.config.configuration import PREPROCESSING_OBJ_FILE,TRANSFORM_TRAIN_FILE_PATH,TRANSFORM_TEST_FILE_PATH,FEATURE_ENGEE_OBJ_FILE_PATH
...
class DataTransformationConfig():
    ...
    feature_engg_obj_path = FEATURE_ENGEE_OBJ_FILE_PATH
...
class DataTransformation:
    ...
    def inititate_data_transformation(self, train_path, test_path):
        try:
            ...
            save_object(file_path = self.data_transformation_config.proccessed_obj_file_path,
                     obj = fe_obj)
